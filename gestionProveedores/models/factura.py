...
class Factura(models.Model):
    ...
    factura_id_factura_electronica = models.CharField(max_length=100, default="", verbose_name="ID FE")
    ...
    factura_razon_social_adquiriente = models.CharField(max_length=150, default="", verbose_name="Razón social adquiriente")
