...
class CausalDevolucionViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return CausalDevolucion.objects.all()
    ...
    def activate(self, request, pk=None):
        causal = self.get_object()
        causal.status = True  # Requiere campo 'status' en el modelo
        causal.save()
        return Response({'status': 'Causal de devolución activated'})
