...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='terceros_departamento', to='tercero.departamento', verbose_name='Departamento'),
        ),
        migrations.AddField(
            model_name='terceros',
            name='tercero_municipio',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='terceros_municipio', to='tercero.municipio', verbose_name='Municipio'),
        ),
        migrations.AddField(
            model_name='terceros',
            name='tercero_pais',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='terceros_pais', to='tercero.pais', verbose_name='País'),
        ),
    ]
